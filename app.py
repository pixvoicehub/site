...
# Limite recomendado por chunk (ajustável)
...
@app.route('/')
def home():
    return "Serviço de Narração está online (v7.0 - Com Chunking)."
...
def generate_narration():
    ...
    try:
        ...
        # Divide em chunks
        chunks = split_text_into_chunks(normalized_text, max_chars=MAX_CHARS_PER_CHUNK)
